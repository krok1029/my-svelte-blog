...
<svelte:head>
	...
	<meta name="description" content="李明峯的前端程式練習集合，包含 CSS 和 JavaScript 的各種小練習" />
</svelte:head>
	...
	<div class="container mx-auto px-4">
		<div class="max-w-4xl mx-auto text-center">
			<div class="flex justify-center mb-6">
				<div class="w-16 h-16 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full flex items-center justify-center">
		...
		<div class="max-w-6xl mx-auto">
			...
			{:else}
				<div class="text-center py-16">
					...
					<button
						on:click={() => { searchQuery = ''; selectedType = ''; }}
						class="btn-primary"
					>
						清除篩選條件
					</button>
