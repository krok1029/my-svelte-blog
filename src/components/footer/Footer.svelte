...
<footer class="mt-auto mb-0 bg-gray-800">
	<div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
		...
		<div class="mt-8 flex justify-center space-x-6">
			<div class="text-gray-400 hover:text-white">Home</div>
			<div class="text-gray-400 hover:text-white">About</div>
			<div class="text-gray-400 hover:text-white">Contact</div>
